  ...
  <input class="btn btn-default pointer" type="submit" value="Filter">
                ...
                <div class="col-lg-8 col-xl-9 main-content">
                    <div class="shop-banner banner"
                        style="background-image: url(<?php echo asset('/').'front/images/demos/demo22/banner/11.jpeg';?>); background-color: #f2f2f3;">
                        <div class="banner-content">
                           
                            <!--<h1 class="banner-title font-weight-bold text-uppercase">All Products</h1>-->
                        </div>
                    </div>
                    <nav class="toolbox sticky-toolbox sticky-content fix-top">
                        <div class="toolbox-left">
                            ...
                            <div class="toolbox-item toolbox-sort">
                                <label>Sort By :</label>
                                <select name="sortp" id="sortp" class="form-control">
