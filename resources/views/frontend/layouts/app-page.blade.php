...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <script>
        ...
        (function (d) {
            ...
            wf.src = 'public/front/js/webfont.js';
            wf.async = true;
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="#" class="cart-toggle">
                                ...
                                <i class="minicart-icon">
                                    <span class="cart-count"><span id="cartcount">{{$cartCount}}</span><span id="cart_value"></span>
                                </i>
                            </a>
                            <!-- End Cart Toggle -->
                ...
                <div class="container d-block">
                    <div class="row">
                        <div class="col-xl-3 col-lg-4">
                            <div class="dropdown  catdrop menu-fixed has-border">
...
input[type="checkbox"]:checked{
    ...
    $(document).ready(function(){
     ...
     <?php for($j=0;$j<=10;$j++){?>   
        $('.brand<?php echo $j;?>').on('click','', function(){
            var id=$('.cat').val();
            var link=$(this).val();
            $(this).addClass("selected")
             var brand=[];
             $('.brandi li').each(function(i){
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
   ...
   success:function(data){
    ...
    $(".product-wrapper").load("  .product-wrapper >*");
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
   ...
   type:"POST",
   data:{ord:ord},
   url: "{{url('get/search')}}"+"/"+ord,

   success:function(data){

    console.log(data);
   // window.location.reload();
   history.pushState(null, null, ord);
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
   ...
   type:"POST",
   data:{id:id,ord:ord},
   url: "{{url('sort/subcategory')}}"+"/"+id+"/"+ord,
