...
<main class="main">
  ...
  <input class="btn btn-default pointer" type="submit" value="Filter">
                            ...
                            <div class="widget widget-collapsible">
                                ...
                                <li class="brand"><a href="{{route('brand.showBrand',['id'=>$brand->id,'ord'=>'asc'])}}">{{$brand->brand_name}}</a></li>
@endforeach
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-lg-8 col-xl-9 main-content">
                    <div class="shop-banner banner"
                        ...
                        <div class="banner-content">
                            ...
                            <h1 class="banner-title font-weight-bold text-uppercase">{{$brand_name}}</h1>
                        </div>
                    </div>
                    <nav class="toolbox sticky-toolbox sticky-content fix-top">
						...
						<input type="hidden" id="sb" value="{{$brand_id}}">
                        </form>
...
<div class="product-action-vertical">
                                        ...
                                        <input type="hidden" value="1" id="quantity" name="quantity">
                                                ...
                                                <div class="product-action">
                                                    <a href="{{route('single.singleProduct', $product->id)}}" data-id="{{$product->id}}" data-details="{{$product->details}}" data-currency="{{$settings->currency}}" data-url="{{asset('/uploads')}}" data-image="{{ $product->img_name }}" data-price="{{$product->price}}" data-quantity=1 data-product_name="{{$product->title}}" class="btn-product"
