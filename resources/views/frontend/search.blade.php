  ...
  <input class="btn btn-default pointer" type="submit" value="Filter">
                ...
                <div class="col-lg-8 col-xl-9 main-content">
                    <div class="shop-banner banner"
                        style="background-image: url(<?php echo asset('/').'front/images/demos/demo22/banner/44.jpeg';?>); background-color: #f2f2f3;">
                        <div class="banner-content">
                           
                            <!--<h1 class="banner-title font-weight-bold text-uppercase">Search</h1>-->
                        </div>
                    </div>
