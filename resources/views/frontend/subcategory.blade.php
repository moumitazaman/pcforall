...
<main class="main">
  ...
  <input type="hidden" id="amount1" name="min_price" value="0">
    ...
    <input type="hidden" id="subcategory" name="subcategory" value="{{$sub_id}}" >
                ...
                <div class="col-lg-8 col-xl-9 main-content">
                    <div class="shop-banner banner"
                        ...
                        <div class="banner-content">
                            ...
                            <h1 class="banner-title font-weight-bold text-uppercase">{{$sub_name}}</h1>
                        </div>
                    </div>
                    <nav class="toolbox sticky-toolbox sticky-content fix-top">
                        <div class="toolbox-left">
                            ...
                            <div class="toolbox-item toolbox-sort select-box">
                                <label>Sort By :</label>
                                <form>
								<select name="sortsub" id="sortsub" class="form-control">
						...
						<input type="hidden" id="sub" value="{{$sub_id}}">
                        </form>
