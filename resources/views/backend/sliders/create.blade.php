        ...
        <div class="content">
          <div class="container-fluid">
            ...
            <div class="card card-default">
              <!-- form -->
              <form action="{{ route('backend.slider.store') }}" id="sales_info" method="POST" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" placeholder="Slider Name" value="{{ old('title') }}" required>
                        
                      </div>
                      <div class="form-group">
                          <label for="name">Text 1</label>
                          <input type="text" class="form-control" name="text1" placeholder="text" required value="{{ old('storage_size') }}">
                          
                        </div>
                        <div class="form-group">
                          <label for="name">Text 2</label>
                          <input type="text" class="form-control" name="text2" required value="{{ old('storage_size') }}">
                         
                        </div>
                        <div class="form-group">
                          <label for="name">Text 3</label>
                          <input type="text" class="form-control" name="text3" value="{{ old('storage_size') }}">
                      ...
                      <div class="col-md-6"> 
                        ...
                        <input type="text" class="form-control" name="text4" value="{{ old('storage_size') }}">

                      </div>
                      <div class="form-group">
                        <label for="name">Button Text</label>

                        <input type="text" class="form-control" name="btn_text" value="{{ old('storage_size') }}">

                      </div>
                      <div class="form-group">
                        <label for="name">Button Link</label>

                        <input type="text" class="form-control" name="btn_link" value="{{ old('storage_size') }}">

                      </div>

                      <div class="form-group">
                          <label for="name">Upload Image(Minimum 500*400 px)</label>
