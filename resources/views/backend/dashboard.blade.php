              ...
              <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    //$billcount= DB::table('bills')->select('name')->where('created_at',$currentdate)->count();
                    ?>
              ...
              <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    //$prodcount= DB::table('products')->select('id')->count();
                    ?>
                    <span class="info-box-number"></span>
                  </div>
                  <!-- /.info-box-content -->
              ...
              <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    //$totalbill= DB::table('bills')->select('id')->count();
                    ?>
                    <span class="info-box-number"></span>
                  </div>
                  <!-- /.info-box-content -->
              ...
              <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                   ...
                   // $branch= DB::table('branches')->select('id')->count();
                    ?>
