...
(function () {
    ...
    Donald.Shop = {
	 ...
	 var imgsrc =$(this).data('url')+'/'+$(this).data('image');
     ...
     var details = $(this).data('details');
                ...
                Donald.popup({
                    items: {
                        src: "http://pcforall.iciclecorp.space/resources/views/frontend/quickview.blade.php",
                    ...
                    callbacks: {
                        ajaxContentAdded: function () {
                            ...
                            $(".product-details .proid").val( val_id );
                                $(".product-details .product_name").text(product_name );
	 $(".product-single .proimage").attr("src",imgsrc);
     $(".product-details .price").text(price);
     $(".product-details .currency").text(currency);
     $(".product-details .details").text(details);
