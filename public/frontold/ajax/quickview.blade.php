<div class="product product-single row product-popup">
			...
			<div class="product-single-carousel owl-carousel owl-theme owl-nav-inner row cols-1">
				<figure class="product-image">
					<img src="" class="proimage" 
						data-zoom-image="images/product/product-1-800x900.jpg" alt="Blue Pinafore Denim Dress"
			...
			<div class="product-thumbs-wrap">
				<div class="product-thumbs">
					<div class="product-thumb active">
						...
						<img src="images/product/product-1-137x137.jpg" alt="product thumbnail" width="137"
							height="137">
					</div>
					<div class="product-thumb">
						<img src="images/product/product-2-137x137.jpg" alt="product thumbnail" width="137"
							height="137">
					</div>
					<div class="product-thumb">
						<img src="images/product/product-3-137x137.jpg" alt="product thumbnail" width="137"
							height="137">
					</div>
					<div class="product-thumb">
						<img src="images/product/product-4-137x137.jpg" alt="product thumbnail" width="137"
							height="137">
					</div>
					<div class="product-thumb">
						<img src="images/product/product-5-137x137.jpg" alt="product thumbnail" width="137"
							height="137">
					</div>
				</div>
	...
	<div class="col-md-6">
		<div class="product-details scrollable">
			<h2 class="product-name"><a href="product.html"><input type="text" class="product_name" value=""/><span class="product_name" ></span></a></h2>
			<!--<div class="product-meta">
				CATEGORY: <span class="product-sku">12345670</span>
				BRAND: <span class="product-brand">The Northland</span>
			</div>-->
			<div class="product-price"><input type="text" class="currency" value=""/><input type="text" class="price" value=""/></div>
			...
			<p class="product-short-desc"><input type="text" class="details" value=""/></p>
